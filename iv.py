...
class analise_iv:
    ...
    def __get_tab_bivariada(self,var_escolhida):
        ...
        df2 = df_aux.pivot_table(values='target2',index=var_escolhida, columns=self.target,aggfunc='count')
    ...
    def __init__(self,df,target):
        ...
        df_num = self.df.loc[:,((self.df.dtypes == 'int64') | 
        ...
        for var in vars:
            nome_var = 'fx_' + var 
            df_num[nome_var] = pd.qcut(df_num[var], q=10, precision=2,duplicates='drop')
